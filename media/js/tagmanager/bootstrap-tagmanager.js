  ...
  jQuery.fn.tagsManager = function (options,tagToManipulate) {
    ...
    var pushTag = function (tag) {
      ...
      if (alreadyInList) {
        ...
        html += '<span class="myTag'+cl+'" id="' + newTagId + '"><span><a href="/tags/search/' + tag + '">' + tag + '&nbsp;&nbsp;</a></span><a href="#" class="myTagRemover" id="' + newTagRemoveId + '" TagIdToRemove="' + tagId + '" title="Remove">' + tagManagerOptions.tagCloseIcon + '</a></span> ';
