...
urlpatterns = [
	...
	url(r'^accounts/login/$', auth_views.login, {'template_name': 'somesmart/base_login.html'}, name='account-login'),
	url(r'^accounts/logout/$', auth_views.logout, {'template_name': 'somesmart/base_logged_out.html'}, name='account-logout'),
